...
아래 이미지는 **안드로이드 디바이스**에서 `realapp` 디버그 빌드를 실행한 뒤 캡쳐한 6개 하단 탭의 대표 화면입니다.
...
<table>
  <tr>
    <td align="center" width="33%">
      ...
      <b>💞 케미 결과</b><br>
      상대 2000의 케미 점수와 관계 해석
    </td>
    <td align="center" width="33%">
      <img src="realapp/docs/screenshots/realapp-start-screen.png" alt="안드로이드 디바이스 사용자 삭제 후 시작 화면" width="220"><br>
      <b>🚪 사용자 삭제 후 시작</b><br>
      로컬 사용자 데이터 삭제 후 첫 홈 CTA
    </td>
    <td align="center" width="33%">
      <img src="realapp/docs/screenshots/realapp-current-screen.png" alt="안드로이드 디바이스 현재 화면 - 온보딩 기록과 도감" width="220"><br>
      <b>📝 온보딩</b><br>
      기록과 도감이 쌓이는 앱 소개 화면
    </td>
  </tr>
...
| 💞 케미 | 관계를 가볍게 대화 소재로 변환 | 상대 추가(관계 타입: 친구/연인/가족/동료/기타), 오행·십신 기반 케미 점수(총 100), 잘 맞는 점·조심할 소통·함께 좋은 팁, 공유 카드 |
...
- 캡쳐 기준일: **2026-07-08**
- 확인 플로우: 출생 정보 생성 → 홈 진입 → 케미 상대 추가 → 6개 탭 대표 화면 캡쳐 → 사용자 데이터 삭제 후 시작/온보딩 화면 추가 캡쳐
