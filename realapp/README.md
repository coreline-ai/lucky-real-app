...
요청 시점의 안드로이드 디바이스 현재 화면 캡쳐입니다. 2026-07-09 기준, 관심종목 5개가 보이는 시장관찰 목록 화면으로 갱신했습니다.

<p align="center">
  <img src="docs/screenshots/realapp-current-screen.png" alt="안드로이드 디바이스 현재 화면 - 시장관찰 관심종목" width="220">
</p>
