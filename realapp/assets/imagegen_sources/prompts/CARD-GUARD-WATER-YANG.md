# CARD-GUARD-WATER-YANG Prompt Spec

Asset contract:
- Asset ID: CARD-GUARD-WATER-YANG
- Final app output: 1080x1620, vertical 2:3.
- Transparency: Not required. This is opaque reward card art.
- Role: card art for the water yang guardian, used in free collection and reward flows.

Image generation prompt:
```text
Use case: stylized-concept
Asset type: opaque guardian reward card art, vertical 2:3
Primary request: create a card illustration for the water yang wave guardian, representing flow, courage, and adaptive movement
Scene/backdrop: moonlit wave card world with river current ribbons, mist, star reflections, and gentle foam
Subject: elegant non-human wave guardian with flowing water mantle, crescent crest, and calm dynamic stance, placed in the upper third and side-framed by wave ribbons
...
Safe area: keep x=18% to 82% and y=38% to 74% low-detail and free of the guardian face, wave mantle, seals, readable marks, or high-contrast foam
Lighting/mood: cool, flowing, confident, restorative
